<section class="border-t border-[--lp-outline] bg-[--lp-surface]">
    <div class="mx-auto max-w-6xl px-gutter py-space-xl lg:px-space-xl">
        <div class="mx-auto max-w-2xl text-center">
            ...
            <p class="mx-auto mt-space-sm max-w-lg text-pretty font-body-md text-body-md text-[--lp-muted]">From course builder to report card, {{ config('app.name', 'Laravel') }} covers the academic year end to end &mdash; for admins, teacher, and students alike.</p>
        </div>
