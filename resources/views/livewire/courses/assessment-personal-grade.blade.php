...
<div class="space-y-space-lg">
    ...
    <div>
        <a href="{{ route('assessments.personal.show', $assessment) }}" class="text-body-sm text-primary hover:underline inline-flex items-center gap-space-xs">
            ...
            <div class="p-space-lg">
                <form wire:submit="submitGrade" class="space-y-space-md">
                    ...
                    <div class="flex gap-space-md">
                        <a href="{{ route('assessments.personal.show', $assessment) }}" class="px-space-lg py-space-sm border border-outline rounded-lg font-label-md text-label-md text-on-surface hover:bg-surface-container transition">
                            Cancel
                        </a>
                        <button
                            type="submit"
