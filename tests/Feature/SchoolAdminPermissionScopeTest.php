...
test('default school admin role only receives users, roles, permissions, and media permissions', function () {
    ...
    expect($groups)->toEqual(['Media', 'Permissions', 'Roles', 'Users']);
});
