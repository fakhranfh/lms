...
@section('content')
    ...
    <main class="flex flex-1 items-center justify-center p-gutter">
        <div class="w-full max-w-[480px] bg-surface rounded-xl p-space-xl border border-outline-variant shadow-[0_8px_30px_rgb(0,0,0,0.04)]">
            <a href="{{ route('get-started.school'.\App\Support\RootDomains::currentSuffix()) }}" class="inline-flex items-center gap-space-xxs font-body-sm text-body-sm text-secondary hover:text-on-surface mb-space-lg">
