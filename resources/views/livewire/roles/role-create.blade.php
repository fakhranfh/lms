...
<div class="max-w-2xl" x-data='{
    ...
    <form wire:submit="store" class="bg-surface border border-outline-variant rounded-lg p-space-lg space-y-space-lg"
        ...
        <div class="flex items-center gap-space-md">
            <button type="submit" wire:loading.attr="disabled" wire:target="store" class="px-space-lg py-space-sm bg-primary text-on-primary rounded-lg font-label-md text-label-md hover:opacity-90 transition-opacity disabled:opacity-70 disabled:cursor-not-allowed inline-flex items-center gap-space-sm">
                <svg wire:loading wire:target="store" class="animate-spin h-4 w-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
